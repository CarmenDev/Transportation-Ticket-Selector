            ...
            <div className="decisionTreeContainer">
                <Wizard tree={tree} first="touristNumber">
                        ...
                        <div className="stepContent">
                            ...
                            {({ destinations: { junior, daysInBerlin }, back }) => (
                                <div className="buttonContainer">
                                    ...
                                    <button onClick={daysInBerlin}>older than 24</button>
                    ...
                    <Step name="daysInBerlin">
                        <div className="stepContent">
                            <h4>How many days will you spend in Berlin?</h4>
                            <Controls>
                    ...
                    <Step name="withBikes">
                        <div className="stepContent">
                            <h4>Will you bring your bike(s) along?</h4>
                            <Controls>
                    ...
                    <Step name="bikesNumber">
                        <div className="stepContent">
                            <h4>How many bikes will you bring along?</h4>
                            <Controls>
